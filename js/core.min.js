! function(t, e) {
    ...
    var p = function(n) {
        ...
        var t, p, b, r, s, f, d, m, w, l, c, x, C, a, E, g, u, v, y, T = "sizzle" + +new Date,
            _ = n.document,
            S = 0,
            i = 0,
            k = lt(),
        ...
        try {
            z.apply(e = P.call(_.childNodes), _.childNodes), e[_.childNodes.length].nodeType
        } catch (t) {
            z = {
            ...
            if (!i && (x(e), e = e || C, E)) {
                if (11 !== d && (l = et.exec(t)))
                    if (o = l[1]) {
                        ...
                        if ((o = l[3]) && p.getElementsByClassName && e.getElementsByClassName) return z.apply(n, e.getElementsByClassName(o)), n
                    }
                if (p.qsa && !O[t + " "] && (!g || !g.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    if (u = t, h = e, 1 === d && (V.test(t) || U.test(t))) {
                        for ((h = nt.test(t) && mt(e.parentNode) || e) === e && p.scope || ((a = e.getAttribute("id")) ? a = a.replace(ot, rt) : e.setAttribute("id", a = T)), r = (c = f(t)).length; r--;) c[r] = (a ? "#" + a : ":scope") + " " + vt(c[r]);
                        u = c.join(",")
                    }
                    try {
        ...
        for (t in p = at.support = {}, s = at.isXML = function(t) {
                ...
                return i != C && 9 === i.nodeType && i.documentElement && (a = (C = i).documentElement, E = !s(C), _ != C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), p.scope = ut(function(t) {
                ...
                }, u = [], g = [], (p.qsa = tt.test(C.querySelectorAll)) && (ut(function(t) {
                    var e;
                    ...
                    return n || (1 & (n = (t.ownerDocument || t) == (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !p.sortDetached && e.compareDocumentPosition(t) === n ? t == C || t.ownerDocument == _ && y(_, t) ? -1 : e == C || e.ownerDocument == _ && y(_, e) ? 1 : l ? H(l, t) - H(l, e) : 0 : 4 & n ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return c = !0, 0;
                    var n, i = 0,
                        o = t.parentNode,
                ...
                if (x(t), p.matchesSelector && E && !O[e + " "] && (!u || !u.test(e)) && (!g || !g.test(e))) try {
                    var n = v.call(t, e);
                ...
                var n = b.attrHandle[e.toLowerCase()],
                    i = n && L.call(b.attrHandle, e.toLowerCase()) ? n(t, e, !E) : void 0;
                ...
                filter: {
                    ...
                    ATTR: function(n, i, o) {
                        return function(t) {
                            var e = at.attr(t, n);
                            return null == e ? "!=" === i : !i || (e += "", "=" === i ? e === o : "!=" === i ? e !== o : "^=" === i ? o && 0 === e.indexOf(o) : "*=" === i ? o && -1 < e.indexOf(o) : "$=" === i ? o && e.slice(-o.length) === o : "~=" === i ? -1 < (" " + e.replace($, " ") + " ").indexOf(o) : "|=" === i && (e === o || e.slice(0, o.length + 1) === o + "-"))
                        }
                    },
                        ...
                        return 1 === m && 0 === g ? function(t) {
                            ...
                            if (u) {
                                ...
                                if (l = [y ? u.firstChild : u.lastChild], y && d) {
                                    for (p = (a = (i = (o = (r = (s = u)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] || [])[0] === S && i[1]) && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (p = a = 0) || l.pop();)
                                        if (1 === s.nodeType && ++p && s === t) {
                                            o[f] = [S, a, p];
                                            break
                                        }
                                } else if (d && (p = a = (i = (o = (r = (s = t)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] || [])[0] === S && i[1]), !1 === p)
                                    for (;
                                        (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++p || (d && ((o = (r = s[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[f] = [S, p]), s !== t)););
                ...
                pseudos: {
                    ...
                    lang: ct(function(n) {
                        return X.test(n || "") || at.error("unsupported lang: " + n), n = n.replace(it, h).toLowerCase(),
                            function(t) {
                                var e;
                                do {
                ...
                if (e = b.relative[t[a].type]) u = [yt(_t(u), e)];
                    ...
                    if ((e = b.filter[t[a].type].apply(null, t[a].matches))[T]) {
                        ...
                        return function t(p, f, m, g, v, e) {
                            return g && !g[T] && (g = t(g)), v && !v[T] && (v = t(v, e)), ct(function(t, e, n, i) {
                                var o, r, s, a = [],
                                    l = [],
                                    c = e.length,
                                    u = t || function(t, e, n) {
                                    ...
                                    h = !p || !t && f ? u : bt(u, a, p, n, i),
                                    d = m ? v || (t ? p : c || g) ? [] : e : h;
                                if (m && m(h, d, n, i), g)
                                    for (o = bt(d, l), g(o, [], n, i), r = o.length; r--;)(s = o[r]) && (d[l[r]] = !(h[l[r]] = s));
                                if (t) {
                                    if (v || p) {
                                        if (v) {
                                        ...
                                        for (r = d.length; r--;)(s = d[r]) && -1 < (o = v ? H(t, s) : a[r]) && (t[o] = !(e[o] = s))
                                    }
                                } else d = bt(d === e ? d.splice(c, d.length) : d), v ? v(null, e, d, i) : z.apply(e, d)
                            })
        ...
        return gt.prototype = b.filters = b.pseudos, b.setFilters = new gt, f = at.tokenize = function(t, e) {
            var n, i, o, r, s, a, l, c = I[t + " "];
            ...
            return e ? s.length : s ? at.error(t) : I(t, a).slice(0)
        }, d = at.compile = function(t, e) {
            var n, g, v, y, _, i, o = [],
                r = [],
                s = A[t + " "];
            if (!s) {
                for (n = (e = e || f(t)).length; n--;)(s = wt(e[n]))[T] ? o.push(s) : r.push(s);
                (s = A(t, (g = r, y = 0 < (v = o).length, _ = 0 < g.length, i = function(t, e, n, i, o) {
                    var r, s, a, l = 0,
                        c = "0",
                        u = t && [],
                        h = [],
                        ...
                        m = p.length;
                    for (o && (w = e == C || e || o); c !== m && null != (r = p[c]); c++) {
                        if (_ && r) {
                    ...
                    if (l += c, y && c !== l) {
                        ...
                        z.apply(i, h), o && !t && 0 < h.length && 1 < l + v.length && at.uniqueSort(i)
                    }
                    return o && (S = f, w = d), u
                }, y ? ct(i) : i))).selector = t
            }
            ...
            if (n = n || [], 1 === u.length) {
                ...
                for (o = K.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !b.relative[a = s.type]);)
                    if ((l = b.find[a]) && (i = l(s.matches[0].replace(it, h), nt.test(r[0].type) && mt(e.parentNode) || e))) {
                        if (r.splice(o, 1), !(t = i.length && vt(r))) return z.apply(n, i), n;
                        break
                    }
            }
            return (c || d(t, u))(i, e, !E, n, !e || nt.test(t) && mt(e.parentNode) || e), n
        }, p.sortStable = T.split("").sort(D).join("") === T, p.detectDuplicates = !!c, x(), p.sortDetached = ut(function(t) {
    ...
    (T.fn.init = function(t, e, n) {
        var i, o;
        if (!t) return this;
        if (n = n || O, "string" != typeof t) return t.nodeType ? (this[0] = t, this.length = 1, this) : _(t) ? void 0 !== n.ready ? n.ready(t) : t(T) : T.makeArray(t, this);
        if (!(i = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : D.exec(t)) || !i[1] && e) return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
        if (i[1]) {
            if (e = e instanceof T ? e[0] : e, T.merge(this, T.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : E, !0)), I.test(i[1]) && T.isPlainObject(e))
                for (i in e) _(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
            return this
        }
        return (o = E.getElementById(i[2])) && (this[0] = o, this.length = 1), this
    }).prototype = T.fn, O = T(E);
    ...
    T.fn.extend({
        ...
        contents: function(t) {
            return null != t.contentDocument && i(t.contentDocument) ? t.contentDocument : (k(t, "template") && (t = t.content || t), T.merge([], t.childNodes))
        }
    }, function(i, o) {
        T.fn[i] = function(t, e) {
            var n = T.map(this, o, t);
            return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = T.filter(e, n)), 1 < this.length && (N[i] || T.uniqueSort(n), L.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var z = /[^\x20\t\r\n\f]+/g;
    ...
    T.Callbacks = function(i) {
        var n;
        i = "string" == typeof i ? (n = {}, T.each(i.match(z) || [], function(t, e) {
            n[e] = !0
        }), n) : T.extend({}, i);
                ...
                s = {
                    ...
                    then: function(e, n, i) {
                            ...
                            return function() {
                                function t() {
                                    ...
                                    if (!(o < l)) {
                                        ...
                                        e = t && ("object" == typeof t || "function" == typeof t) && t.then, _(e) ? a ? e.call(t, c(l, r, P, a), c(l, r, H, a)) : (l++, e.call(t, c(l, r, P, a), c(l, r, H, a), c(l, r, P, r.notifyWith))) : (s !== P && (n = void 0, i = [t]), (a || r.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                        ...
                        return T.Deferred(function(t) {
                            r[0][3].add(c(0, t, _(i) ? i : P, t.notifyWith)), r[1][3].add(c(0, t, _(e) ? e : P)), r[2][3].add(c(0, t, _(n) ? n : H))
                        }).promise()
                    },
                    promise: function(t) {
    ...
    }), T.ready.then = R.then, "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? C.setTimeout(T.ready) : (E.addEventListener("DOMContentLoaded", W), C.addEventListener("load", W));
    ...
    function U(t) {
        return t.replace($, "ms-").replace(B, Q)
    }
    ...
    Y.uid = 1, Y.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== e) {
                    n = (e = Array.isArray(e) ? e.map(U) : (e = U(e)) in i ? [e] : e.match(z) || []).length;
                    for (; n--;) delete i[e[n]]
                }
    ...
    T.extend({
        ...
        data: function(n, t) {
            ...
            if (void 0 !== n) return "object" == typeof n ? this.each(function() {
                ...
                var e;
                return r && void 0 === t ? void 0 !== (e = K.get(r, n)) || void 0 !== (e = J(r, n)) ? e : void 0 : void this.each(function() {
                    K.set(this, n, t)
                })
        ...
        promise: function(t, e) {
            ...
            var i, o = 1,
                ...
                s = this,
                a = this.length;
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;)(i = X.get(s[a], t + "queueHooks")) && i.empty && (o++, i.empty.add(n));
    ...
    function ct(t, e) {
        for (var n, i, o, r, s, a, l = [], c = 0, u = t.length; c < u; c++)(i = t[c]).style && (n = i.style.display, e ? ("none" === n && (l[c] = X.get(i, "display") || null, l[c] || (i.style.display = "")), "" === i.style.display && st(i) && (l[c] = (a = r = o = void 0, r = i.ownerDocument, s = i.nodeName, (a = lt[s]) || (o = r.body.appendChild(r.createElement(s)), a = T.css(o, "display"), o.parentNode.removeChild(o), "none" === a && (a = "block"), lt[s] = a)))) : "none" !== n && (l[c] = "none", X.set(i, "display", n)));
    ...
    var ut, ht = /^(?:checkbox|radio)$/i,
        ...
        ft = E.createDocumentFragment().appendChild(E.createElement("div"));
    (ut = E.createElement("input")).setAttribute("type", "radio"), ut.setAttribute("checked", "checked"), ut.setAttribute("name", "t"), ft.appendChild(ut), y.checkClone = ft.cloneNode(!0).cloneNode(!0).lastChild.checked, ft.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !!ft.cloneNode(!0).lastChild.defaultValue, ft.innerHTML = "<option></option>", y.option = !!ft.lastChild;
    var mt = {
        thead: [1, "<table>", "</table>"],
    ...
    function gt(t, e) {
        ...
        return void 0 === e || e && k(t, e) ? T.merge([t], n) : n
    }
    ...
    function _t(t, e, n, i, o) {
        for (var r, s, a, l, c, u, h = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
            ...
            for (s = s || h.appendChild(e.createElement("div")), a = (dt.exec(r) || ["", ""])[1].toLowerCase(), l = mt[a] || mt._default, s.innerHTML = l[1] + T.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
            T.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
        } else d.push(e.createTextNode(r));
        for (h.textContent = "", p = 0; r = d[p++];)
            if (i && -1 < T.inArray(r, i)) o && o.push(r);
            else if (c = ot(r), s = gt(h.appendChild(r), "script"), c && vt(s), n)
    ...
    function kt(t, o, r) {
        r ? (X.set(t, o, !1), T.event.add(t, o, {
            namespace: !1,
            handler: function(t) {
                var e, n, i = X.get(this, o);
                if (1 & t.isTrigger && this[o]) {
                    if (i.length)(T.event.special[o] || {}).delegateType && t.stopPropagation();
                    else if (i = a.call(arguments), X.set(this, o, i), e = r(this, o), this[o](), i !== (n = X.get(this, o)) || e ? X.set(this, o, !1) : n = {}, i !== n) return t.stopImmediatePropagation(), t.preventDefault(), n.value
                } else i.length && (X.set(this, o, {
                    value: T.event.trigger(T.extend(i[0], T.Event.prototype), i.slice(1), this)
                }), t.stopImmediatePropagation())
            }
        })) : void 0 === X.get(t, o) && T.event.add(t, o, Ct)
    }
    T.event = {
        global: {},
        add: function(e, t, n, i, o) {
            var r, s, a, l, c, u, h, d, p, f, m, g = X.get(e);
            if (V(e))
                for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(it, o), n.guid || (n.guid = T.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function(t) {
                        return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(z) || [""]).length; c--;) p = m = (a = xt.exec(t[c]) || [])[1], f = (a[2] || "").split(".").sort(), p && (h = T.event.special[p] || {}, p = (o ? h.delegateType : h.bindType) || p, h = T.event.special[p] || {}, u = T.extend({
                    type: p,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, r), (d = l[p]) || ((d = l[p] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(e, i, f, s) || e.addEventListener && e.addEventListener(p, s)), h.add && (h.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), T.event.global[p] = !0)
        },
        remove: function(t, e, n, i, o) {
            var r, s, a, l, c, u, h, d, p, f, m, g = X.hasData(t) && X.get(t);
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(z) || [""]).length; c--;)
                    if (p = m = (a = xt.exec(e[c]) || [])[1], f = (a[2] || "").split(".").sort(), p) {
                        for (h = T.event.special[p] || {}, d = l[p = (i ? h.delegateType : h.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--;) u = d[r], !o && m !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(r, 1), u.selector && d.delegateCount--, h.remove && h.remove.call(t, u));
                        s && !d.length && (h.teardown && !1 !== h.teardown.call(t, f, g.handle) || T.removeEvent(t, p, g.handle), delete l[p])
                    } else
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && k(e, "input") && kt(e, "click", Ct), !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && k(e, "input") && kt(e, "click"), !0
                },
                _default: function(t) {
                    var e = t.target;
                    return ht.test(e.type) && e.click && k(e, "input") && X.get(e, "click") || k(e, "a")
                }
            },
            beforeunload: {
        ...
        off: function(t, e, n) {
            ...
            if ("object" != typeof t) return !1 !== e && "function" != typeof e || (n = e, e = void 0), !1 === n && (n = Et), this.each(function() {
    ...
    function jt(t, e) {
        ...
        if (1 === e.nodeType) {
            if (X.hasData(t) && (a = X.get(t).events))
                for (o in X.remove(e, "handle events"), a)
                    for (n = 0, i = a[o].length; n < i; n++) T.event.add(e, o, a[o][n]);
            K.hasData(t) && (r = K.access(t), s = T.extend({}, r), K.set(e, s))
        }
    }
    ...
    function zt(n, i, o, r) {
        ...
        var t, e, s, a, l, c, u = 0,
            ...
            p = i[0],
            f = _(p);
        if (f || 1 < h && "string" == typeof p && !y.checkClone && At.test(p)) return n.each(function(t) {
            var e = n.eq(t);
            f && (i[0] = p.call(this, t, e.html())), zt(e, i, o, r)
        });
        if (h && (e = (t = _t(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), e || r)) {
            for (a = (s = T.map(gt(t, "script"), Lt)).length; u < h; u++) l = t, u !== d && (l = T.clone(l, !0, !0), a && T.merge(s, gt(l, "script"))), o.call(n[u], l, u);
            if (a)
                for (c = s[s.length - 1].ownerDocument, T.map(s, Nt), u = 0; u < a; u++) l = s[u], pt.test(l.type || "") && !X.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
    ...
    function Pt(t, e, n) {
        for (var i, o = e ? T.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || T.cleanData(gt(i)), i.parentNode && (n && ot(i) && vt(gt(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    T.extend({
        ...
        clone: function(t, e, n) {
            ...
            if (!(y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t)))
                for (s = gt(u), i = 0, o = (r = gt(t)).length; i < o; i++) a = r[i], "input" === (c = (l = s[i]).nodeName.toLowerCase()) && ht.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (n)
                    for (r = r || gt(t), s = s || gt(u), i = 0, o = r.length; i < o; i++) jt(r[i], s[i]);
                else jt(t, u);
        ...
        html: function(t) {
            return F(this, function(t) {
                ...
                if ("string" == typeof t && !It.test(t) && !mt[(dt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = T.htmlPrefilter(t);
                    try {
    ...
    var Mt, qt, Rt, Wt, Ft, $t, Bt, Qt, Ut = new RegExp("^(" + tt + ")(?!px)[a-z%]+$", "i"),
        Vt = function(t) {
    ...
    function Xt(t, e, n) {
        ...
        return (n = n || Vt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || ot(t) || (s = T.style(t, e)), !y.pixelBoxStyles() && Ut.test(s) && Yt.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function Gt() {
        var t;
        Qt && (Bt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Qt.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", it.appendChild(Bt).appendChild(Qt), t = C.getComputedStyle(Qt), Mt = "1%" !== t.top, $t = 12 === Zt(t.marginLeft), Qt.style.right = "60%", Wt = 36 === Zt(t.right), qt = 36 === Zt(t.width), Qt.style.position = "absolute", Rt = 12 === Zt(Qt.offsetWidth / 3), it.removeChild(Bt), Qt = null)
    }

    function Zt(t) {
        return Math.round(parseFloat(t))
    }
    Bt = E.createElement("div"), (Qt = E.createElement("div")).style && (Qt.style.backgroundClip = "content-box", Qt.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Qt.style.backgroundClip, T.extend(y, {
        ...
        reliableTrDimensions: function() {
            var t, e, n, i;
            return null == Ft && (t = E.createElement("table"), e = E.createElement("tr"), n = E.createElement("div"), t.style.cssText = "position:absolute;left:-11111px", e.style.height = "1px", n.style.height = "9px", it.appendChild(t).appendChild(e).appendChild(n), i = C.getComputedStyle(e), Ft = 3 < parseInt(i.height), it.removeChild(t)), Ft
        }
    }));
    ...
    function ce(t, e, n) {
        ...
        return (!y.boxSizingReliable() && o || !y.reliableTrDimensions() && k(t, "tr") || "auto" === s || !parseFloat(s) && "inline" === T.css(t, "display", !1, i)) && t.getClientRects().length && (o = "border-box" === T.css(t, "boxSizing", !1, i), (r = a in t) && (s = t[a])), (s = parseFloat(s) || 0) + le(t, e, n || (o ? "border" : "content"), r, i, s) + "px"
    }
    ...
    T.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                "string" == (r = typeof n) && (o = et.exec(n)) && o[1] && (n = at(t, e, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (T.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? c.setProperty(e, n) : c[e] = n))
            }
        },
        css: function(t, e, n, i) {
            var o, r, s, a = U(e);
            return oe.test(e) || (e = ne(a)), (s = T.cssHooks[e] || T.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = Xt(t, e, i)), "normal" === o && e in se && (o = se[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
        ...
        css: function(t, e) {
            return F(this, function(t, e, n) {
                var i, o, r = {},
                    s = 0;
                if (Array.isArray(e)) {
                    for (i = Vt(t), o = e.length; s < o; s++) r[e[s]] = T.css(t, e[s], !1, i);
                    return r
                }
    ...
    function ve() {
        de && (!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(ve) : C.setTimeout(ve, T.fx.interval), T.fx.tick())
    }
    ...
    function we(r, t, e) {
        var n, s, i = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var t = he || ye(), e = Math.max(0, c.startTime + c.duration - t), n = 1 - (e / c.duration || 0), i = 0, o = c.tweens.length; i < o; i++) c.tweens[i].run(n);
        ...
        for (function(t, e) {
                var n, i, o, r, s;
                for (n in t)
                    if (o = e[i = U(n)], r = t[n], Array.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = T.cssHooks[i]) && "expand" in s)
    ...
    T.Animation = T.extend(we, {
        ...
        tweener: function(t, e) {
            for (var n, i = 0, o = (t = _(t) ? (e = t, ["*"]) : t.match(z)).length; i < o; i++) n = t[i], we.tweeners[n] = we.tweeners[n] || [], we.tweeners[n].unshift(e)
        },
        prefilters: [function(t, e, n) {
            ...
            if ((l = !T.isEmptyObject(e)) || !T.isEmptyObject(p))
                for (i in h && 1 === t.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = g && g.display) && (c = X.get(t, "display")), "none" === (u = T.css(t, "display")) && (c ? u = c : (ct([t], !0), c = t.style.display || c, u = T.css(t, "display"), ct([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(t, "float") && (l || (d.done(function() {
                        f.display = c
                    ...
                    for (i in m || ct([t]), X.remove(t, "fxshow"), p) T.style(t, i, p[i])
                })), l = be(m ? g[i] : 0, i, d), i in g || (g[i] = l.start, m && (l.end = l.start, l.start = 0))
        }],
    ...
    }, pe = E.createElement("input"), fe = E.createElement("select").appendChild(E.createElement("option")), pe.type = "checkbox", y.checkOn = "" !== pe.value, y.optSelected = fe.selected, (pe = E.createElement("input")).value = "t", pe.type = "radio", y.radioValue = "t" === pe.value;
    ...
    T.fn.extend({
        ...
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? T.prop(t, e, n) : (1 === r && T.isXMLDoc(t) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? xe : void 0)), void 0 !== n ? null === n ? void T.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : !(o && "get" in o && null !== (i = o.get(t, e))) && null == (i = T.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    T.fn.extend({
        ...
        toggleClass: function(o, e) {
            ...
            return "boolean" == typeof e && s ? e ? this.addClass(o) : this.removeClass(o) : _(o) ? this.each(function(t) {
                ...
                var t, e, n, i;
                if (s)
                    for (e = 0, n = T(this), i = Ie(o); t = i[e++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
                else void 0 !== o && "boolean" != r || ((t = ke(this)) && X.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", !t && !1 !== o && X.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            for (var e, n = 0, i = " " + t + " "; e = this[n++];)
                if (1 === e.nodeType && -1 < (" " + Se(ke(e)) + " ").indexOf(i)) return !0;
            return !1
        }
    });
    var Ae = /\r/g;
    T.fn.extend({
        val: function(n) {
            ...
            })) : e ? (i = T.valHooks[e.type] || T.valHooks[e.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(e, "value")) ? t : "string" == typeof(t = e.value) ? t.replace(Ae, "") : null == t ? "" : t : void 0
        }
    }), T.extend({
        valHooks: {
            option: {
            ...
            select: {
                get: function(t) {
                    for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type, s = r ? null : [], a = r ? o + 1 : i.length, l = o < 0 ? a : r ? o : 0; l < a; l++)
                        if (((n = i[l]).selected || l === o) && !n.disabled && (!n.parentNode.disabled || !k(n.parentNode, "optgroup"))) {
    ...
    T.extend(T.event, {
        trigger: function(t, e, n, i) {
            var o, r, s, a, l, c, u, h = [n || E],
                d = v.call(t, "type") ? t.type : t,
                p = v.call(t, "namespace") ? t.namespace.split(".") : [],
                f = u = r = n = n || E;
            if (3 !== n.nodeType && 8 !== n.nodeType && !De.test(d + T.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), p.sort()), a = d.indexOf(":") < 0 && "on" + d, (t = t[T.expando] ? t : new T.Event(d, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : T.makeArray(e, [t]), c = T.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, e))) {
                if (!i && !c.noBubble && !m(n)) {
                    for (s = c.delegateType || d, De.test(s + d) || (f = f.parentNode); f; f = f.parentNode) h.push(f), r = f;
                    r === (n.ownerDocument || E) && h.push(r.defaultView || r.parentWindow || C)
                }
                for (o = 0;
                    (f = h[o++]) && !t.isPropagationStopped();) u = f, t.type = 1 < o ? s : c.bindType || d, (l = (X.get(f, "events") || Object.create(null))[t.type] && X.get(f, "handle")) && l.apply(f, e), (l = a && f[a]) && l.apply && V(f) && (t.result = l.apply(f, e), !1 === t.result && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), e) || !V(n) || a && _(n[d]) && !m(n) && ((r = n[a]) && (n[a] = null), T.event.triggered = d, t.isPropagationStopped() && u.addEventListener(d, Oe), n[d](), t.isPropagationStopped() && u.removeEventListener(d, Oe), T.event.triggered = void 0, r && (n[a] = r)), t.result
            }
        },
        ...
        if (Array.isArray(t) || t.jquery && !T.isPlainObject(t)) T.each(t, function() {
            ...
            for (i in t) ! function n(i, t, o, r) {
                ...
                if (Array.isArray(t)) T.each(t, function(t, e) {
                    o || ze.test(i) ? r(i, e) : n(i + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, o, r)
                });
    ...
    Ye.href = Le.href, T.extend({
        ...
        ajax: function(t, e) {
            ...
            var u, h, d, n, p, i, f, m, o, r, g = T.ajaxSetup({}, e),
                v = g.context || g,
                ...
                x = {
                    ...
                    getResponseHeader: function(t) {
                        ...
                        if (f) {
                            if (!n)
                                for (n = {}; e = Fe.exec(d);) n[e[1].toLowerCase() + " "] = (n[e[1].toLowerCase() + " "] || []).concat(e[2]);
                            e = n[t.toLowerCase() + " "]
                        }
            ...
            if (_.promise(x), g.url = ((t || g.url || Le.href) + "").replace(Be, Le.protocol + "//"), g.type = e.method || e.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(z) || [""], null == g.crossDomain) {
                i = E.createElement("a");
                try {
                    i.href = g.url, i.href, g.crossDomain = Ye.protocol + "//" + Ye.host != i.protocol + "//" + i.host
                } catch (t) {
                    g.crossDomain = !0
                }
            }
            if (g.data && g.processData && "string" != typeof g.data && (g.data = T.param(g.data, g.traditional)), Ke(Qe, g, e, x), f) return x;
            for (o in (m = T.event && g.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !$e.test(g.type), h = g.url.replace(Re, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(qe, "+")) : (r = g.url.slice(h.length), g.data && (g.processData || "string" == typeof g.data) && (h += (je.test(h) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (h = h.replace(We, "$1"), r = (je.test(h) ? "&" : "?") + "_=" + Ne.guid++ + r), g.url = h + r), g.ifModified && (T.lastModified[h] && x.setRequestHeader("If-Modified-Since", T.lastModified[h]), T.etag[h] && x.setRequestHeader("If-None-Match", T.etag[h])), (g.data && g.hasContent && !1 !== g.contentType || e.contentType) && x.setRequestHeader("Content-Type", g.contentType), x.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Ve + "; q=0.01" : "") : g.accepts["*"]), g.headers) x.setRequestHeader(o, g.headers[o]);
            if (g.beforeSend && (!1 === g.beforeSend.call(v, x, g) || f)) return x.abort();
            if (l = "abort", b.add(g.complete), x.done(g.success), x.fail(g.error), u = Ke(Ue, g, e, x)) {
            ...
            function c(t, e, n, i) {
                ...
                }(g, x, n)), !o && -1 < T.inArray("script", g.dataTypes) && (g.converters["text script"] = function() {}), a = function(t, e, n, i) {
                    var o, r, s, a, l, c = {},
                        u = t.dataTypes.slice();
                    if (u[1])
                ...
                }(g, a, x, o), o ? (g.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (T.lastModified[h] = l), (l = x.getResponseHeader("etag")) && (T.etag[h] = l)), 204 === t || "HEAD" === g.type ? c = "nocontent" : 304 === t ? c = "notmodified" : (c = a.state, r = a.data, o = !(s = a.error))) : (s = c, !t && c || (c = "error", t < 0 && (t = 0))), x.status = t, x.statusText = (e || c) + "", o ? _.resolveWith(v, [r, c, x]) : _.rejectWith(v, [x, c, s]), x.statusCode(w), w = void 0, m && y.trigger(o ? "ajaxSuccess" : "ajaxError", [x, g, o ? r : s]), b.fireWith(v, [x, c]), m && (y.trigger("ajaxComplete", [x, g]), --T.active || T.event.trigger("ajaxStop")))
            }
            return x
        },
    ...
    T.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = en.pop() || T.expando + "_" + Ne.guid++;
            return this[t] = !0, t
        }
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = _(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(nn, "$1" + i) : !1 !== t.jsonp && (t.url += (je.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            return r || T.error(i + " was not called"), r[0]
        }, t.dataTypes[0] = "json", o = C[i], C[i] = function() {
            r = arguments
        }, n.always(function() {
            void 0 === o ? T(C).removeProp(i) : C[i] = o, t[i] && (t.jsonpCallback = e.jsonpCallback, en.push(i)), r && _(o) && o(r[0]), r = o = void 0
        }), "script"
        ...
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (y.createHTMLDocument ? ((i = (e = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, e.head.appendChild(i)) : e = E), r = !n && [], (o = I.exec(t)) ? [e.createElement(o[1])] : (o = _t([t], e, r), r && r.length && T(r).remove(), T.merge([], o.childNodes)));
        var i, o, r
    }, T.fn.load = function(t, e, n) {
        var i, o, r, s = this,
            a = t.indexOf(" ");
        return -1 < a && (i = Se(t.slice(a)), t = t.slice(0, a)), _(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), 0 < s.length && T.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
            data: e
        ...
        T.cssHooks[n] = Kt(y.pixelPosition, function(t, e) {
            if (e) return e = Xt(t, n), Ut.test(e) ? T(t).position()[n] + "px" : e
        })
    }), T.each({
        Height: "height",
        Width: "width"
        ...
        T.each({
            ...
            T.fn[r] = function(t, e) {
                ...
                return F(this, function(t, e, n) {
                    var i;
                    return m(t) ? 0 === r.indexOf("outer") ? t["inner" + s] : t.document.documentElement["client" + s] : 9 === t.nodeType ? (i = t.documentElement, Math.max(t.body["scroll" + s], i["scroll" + s], t.body["offset" + s], i["offset" + s], i["client" + s])) : void 0 === n ? T.css(t, e, o) : T.style(t, e, n, o)
                }, a, n ? t : void 0, n)
            }
        })
    ...
    T.proxy = function(t, e) {
        var n, i, o;
        if ("string" == typeof e && (n = t[e], e = t, t = n), _(t)) return i = a.call(arguments, 2), (o = function() {
            return t.apply(e || this, i.concat(a.call(arguments)))
        }).guid = t.guid = t.guid || T.guid++, o
    }, T.holdReady = function(t) {
        t ? T.readyWait++ : T.ready(!0)
    }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = k, T.isFunction = _, T.isWindow = m, T.camelCase = U, T.type = w, T.now = Date.now, T.isNumeric = function(t) {
        var e = T.type(t);
...
function(t, e) {
    ...
    function m(t) {
        ...
        var e = b(t),
            ...
            i = e.overflowX,
            o = e.overflowY;
        return /(auto|scroll|overlay)/.test(n + o + i) ? t : m(f(t))
    }
    ...
    function _(t) {
        ...
        var i = n && n.nodeName;
        return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === b(n, "position") ? _(n) : n : t ? t.ownerDocument.documentElement : document.documentElement
    }
    ...
    function y(t, e) {
        ...
        if (t !== l && e !== l || i.contains(o)) return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && _(s.firstElementChild) !== s ? _(l) : l;
        var c = u(t);
    ...
    function o(t, e, n, i) {
        return R(e["offset" + t], e["scroll" + t], n["client" + t], n["offset" + t], n["scroll" + t], v(10) ? parseInt(n["offset" + t]) + parseInt(i["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }
    ...
    function E(t) {
        var e, n, i = {};
        try {
            v(10) ? (i = t.getBoundingClientRect(), e = w(t, "top"), n = w(t, "left"), i.top += e, i.left += n, i.bottom += e, i.right += n) : i = t.getBoundingClientRect()
        } catch (t) {}
        var o, r = {
                left: i.left,
                top: i.top,
            ...
            c = t.offsetWidth - a,
            u = t.offsetHeight - l;
        return (c || u) && (c -= h(o = b(t), "x"), u -= h(o, "y"), r.width -= c, r.height -= u), C(r)
    }
    ...
    function T(t, e, n) {
        ...
        i && r && (a.top = R(a.top, 0), a.left = R(a.left, 0));
        var d, p, f = C({
            top: s.top - a.top - u,
        ...
        return f.marginTop = 0, f.marginLeft = 0, !o && r && (d = parseFloat(c.marginTop, 10), p = parseFloat(c.marginLeft, 10), f.top -= u - d, f.bottom -= u - d, f.left -= h - p, f.right -= h - p, f.marginTop = d, f.marginLeft = p), (o && !i ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (f = function(t, e, n) {
            var i = 2 < arguments.length && void 0 !== n && n,
                o = w(e, "top"),
                r = w(e, "left"),
                s = i ? -1 : 1;
    ...
    function p(t, e, n, i, o) {
        ...
        "viewport" === i ? h = function(t, e) {
            var n = 1 < arguments.length && void 0 !== e && e,
                ...
                o = T(t, i),
                r = R(i.clientWidth, window.innerWidth || 0),
                s = R(i.clientHeight, window.innerHeight || 0),
                a = n ? 0 : w(i),
                l = n ? 0 : w(i, "left");
            return C({
        ...
        }(d, u) : ("scrollParent" === i ? "BODY" === (r = m(f(e))).nodeName && (r = t.ownerDocument.documentElement) : r = "window" === i ? t.ownerDocument.documentElement : i, s = T(r, d, u), "HTML" !== r.nodeName || function t(e) {
            var n = e.nodeName;
            if ("BODY" === n || "HTML" === n) return !1;
            if ("fixed" === b(e, "position")) return !0;
            var i = f(e);
            return !!i && t(i)
        }(d) ? h = s : (l = (a = x(t.ownerDocument)).height, c = a.width, h.top += s.top - s.marginTop, h.bottom = l + s.top, h.left += s.left - s.marginLeft, h.right = c + s.left));
        var p = "number" == typeof(n = n || 0);
        return h.left += p ? n : n.left || 0, h.top += p ? n : n.top || 0, h.right -= p ? n : n.right || 0, h.bottom -= p ? n : n.bottom || 0, h
    }
    ...
    function D(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && r(e) && (n.offsets.popper = C(n.offsets.popper), n.offsets.reference = C(n.offsets.reference), n = e(n, t))
        }), n
    }
    ...
    var H = Math.min,
        ...
        B = W && !(!window.MSInputMethodContext || !document.documentMode),
        ...
        X = W && /Firefox/i.test(navigator.userAgent),
    ...
    function nt(t, e) {
        ...
        U(this, nt), this.scheduleUpdate = function() {
            return requestAnimationFrame(n.update)
        }, this.update = $(this.update.bind(this)), this.options = Y({}, nt.Defaults, i), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(Y({}, nt.Defaults.modifiers, i.modifiers)).forEach(function(t) {
            n.options.modifiers[t] = Y({}, nt.Defaults.modifiers[t] || {}, i.modifiers ? i.modifiers[t] : {})
    ...
    return et.Utils = ("undefined" == typeof window ? global : window).PopperUtils, et.placements = K, et.Defaults = {
        ...
        modifiers: {
            shift: {
                ...
                fn: function(t) {
                    ...
                    return u && (n = (e = t.offsets).reference, i = e.popper, s = (o = -1 !== ["bottom", "top"].indexOf(c)) ? "width" : "height", a = {
                        start: P({}, r = o ? "left" : "top", n[r]),
                        end: P({}, r, n[r] + n[s] - i[s])
                    }, t.offsets.popper = Y({}, i, a[u])), t
                }
            },
            offset: {
                order: 200,
            ...
            preventOverflow: {
                ...
                enabled: !0,
                fn: function(t, i) {
                    var e = i.boundariesElement || _(t.instance.popper);
                    ...
                    var n = L("transform"),
                        ...
                        a = o[n];
                    o.top = "", o.left = "", o[n] = "";
                    var l = p(t.instance.popper, t.instance.reference, i.padding, e, t.positionFixed);
                    ...
                    var c = i.priority,
                        ...
                        h = {
                            primary: function(t) {
                                var e = u[t];
                                return u[t] < l[t] && !i.escapeWithReference && (e = R(u[t], l[t])), P({}, t, e)
                            },
                            secondary: function(t) {
                                var e = "right" === t ? "left" : "top",
                                    n = u[e];
                                return u[t] > l[t] && !i.escapeWithReference && (n = H(u[e], l[t] - ("right" === t ? u.width : u.height))), P({}, e, n)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    var m = a[h] + a[c] / 2 - f / 2,
                        ...
                        _ = R(H(s[c] - f, _), 0);
                    return t.arrowElement = i, t.offsets.arrow = (P(n = {}, h, q(_)), P(n, d, ""), n), t
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(g, v) {
                    ...
                    var y = p(g.instance.popper, g.instance.reference, v.padding, v.boundariesElement, g.positionFixed),
                    ...
                    return x.forEach(function(t, e) {
                        if (_ !== t || x.length === e + 1) return g;
                        _ = g.placement.split("-")[0], b = I(_);
                        var n, i = g.offsets.popper,
                            ...
                            p = !!v.flipVariations && (d && "start" === w && a || d && "end" === w && l || !d && "start" === w && c || !d && "end" === w && u),
                            f = !!v.flipVariationsByContent && (d && "start" === w && l || d && "end" === w && a || !d && "start" === w && u || !d && "end" === w && c),
                            m = p || f;
                        (s || h || m) && (g.flipped = !0, (s || h) && (_ = x[e + 1]), m && (w = "end" === (n = w) ? "start" : "start" === n ? "end" : n), g.placement = _ + (w ? "-" + w : ""), g.offsets.popper = Y({}, g.offsets.popper, A(g.instance.popper, g.offsets.reference, g.placement)), g = D(g.instance.modifiers, g, "flip"))
                    }), g
                },
                behavior: "flip",
                padding: 5,
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var s, a, l = void 0 === r ? e.gpuAcceleration : r,
                        c = _(t.instance.popper),
                        u = E(c),
                        h = {
                            position: o.position
                        },
                        d = N(t, window.devicePixelRatio < 2 || !X),
                        p = "bottom" === n ? "top" : "bottom",
                        f = "right" === i ? "left" : "right",
                        m = L("transform"),
                        g = "bottom" == p ? "HTML" === c.nodeName ? -c.clientHeight + d.bottom : -u.height + d.bottom : d.top,
                        v = "right" == f ? "HTML" === c.nodeName ? -c.clientWidth + d.right : -u.width + d.right : d.left;
                    l && m ? (h[m] = "translate3d(" + v + "px, " + g + "px, 0)", h[p] = 0, h[f] = 0, h.willChange = "transform") : (s = "bottom" == p ? -1 : 1, a = "right" == f ? -1 : 1, h[p] = g * s, h[f] = v * a, h.willChange = p + ", " + f);
                    var y = {
                        "x-placement": t.placement
                    };
                    return t.attributes = Y({}, y, t.attributes), t.styles = Y({}, h, t.styles), t.arrowStyles = Y({}, t.offsets.arrow, t.arrowStyles), t
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
...
function(t, e) {
    ...
    var n, o = "alert",
        ...
        l = ((n = c.prototype).close = function(t) {
            ...
            var t, n = this;
            f(e).removeClass("show"), f(e).hasClass("fade") ? (t = m.getTransitionDurationFromElement(e), f(e).one(m.TRANSITION_END, function(t) {
    ...
    f(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', l._handleDismiss(new l)), f.fn[o] = l._jQueryInterface, f.fn[o].Constructor = l, f.fn[o].noConflict = function() {
        return f.fn[o] = a, l._jQueryInterface
    };
    var u, d = f.fn.button,
        p = ((u = g.prototype).toggle = function() {
            var t, e, n = !0,
                i = !0,
                o = f(this._element).closest('[data-toggle="buttons"]')[0];
            !o || (t = this._element.querySelector('input:not([type="hidden"])')) && ("radio" === t.type && (t.checked && this._element.classList.contains("active") ? n = !1 : (e = o.querySelector(".active")) && f(e).removeClass("active")), n && ("checkbox" !== t.type && "radio" !== t.type || (t.checked = !this._element.classList.contains("active")), f(t).trigger("change")), t.focus(), i = !1), this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (i && this._element.setAttribute("aria-pressed", !this._element.classList.contains("active")), n && f(this._element).toggleClass("active"))
        }, u.dispose = function() {
            f.removeData(this._element, "bs.button"), this._element = null
        }, g._jQueryInterface = function(e) {
            return this.each(function() {
                var t = f(this).data("bs.button");
                t || (t = new g(this), f(this).data("bs.button", t)), "toggle" === e && t[e]()
            })
        }, r(g, null, [{
            key: "VERSION",
            get: function() {
    ...
    f(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        ...
        if (f(e).hasClass("btn") || (e = f(e).closest(".btn")[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled")) t.preventDefault();
            ...
            "LABEL" === n.tagName && i && "checkbox" === i.type && t.preventDefault(), p._jQueryInterface.call(f(e), "toggle")
        }
    ...
    }), f.fn.button = p._jQueryInterface, f.fn.button.Constructor = p, f.fn.button.noConflict = function() {
        return f.fn.button = d, p._jQueryInterface
    };
    var v, y = "carousel",
        _ = f.fn[y],
        b = {
        ...
        C = ((v = E.prototype).next = function() {
            ...
            return t = s(s({}, b), t), m.typeCheckConfig(y, t, w), t
            ...
            var n, i, o, r, s, a = this,
                ...
                p = "next" === t ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", i = "carousel-item-prev", "right");
            u && f(u).hasClass("active") ? this._isSliding = !1 : !this._triggerSlideEvent(u, p).isDefaultPrevented() && l && u && (this._isSliding = !0, d && this.pause(), this._setActiveIndicatorElement(u), o = f.Event("slid.bs.carousel", {
                relatedTarget: u,
                direction: p,
                from: c,
                to: h
            }), f(this._element).hasClass("slide") ? (f(u).addClass(i), m.reflow(u), f(l).addClass(n), f(u).addClass(n), (r = parseInt(u.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, this._config.interval = r) : this._config.interval = this._config.defaultInterval || this._config.interval, s = m.getTransitionDurationFromElement(l), f(l).one(m.TRANSITION_END, function() {
                f(u).removeClass(n + " " + i).addClass("active"), f(l).removeClass("active " + i + " " + n), a._isSliding = !1, setTimeout(function() {
                    return f(a._element).trigger(o)
                }, 0)
            }).emulateTransitionEnd(s)) : (f(l).removeClass("active"), f(u).addClass("active"), this._isSliding = !1, f(this._element).trigger(o)), d && this.cycle())
            ...
            return this.each(function() {
                ...
                if (t || (t = new E(this, e), f(this).data("bs.carousel", t)), "number" == typeof i) t.to(i);
            ...
            !o || (e = f(o)[0]) && f(e).hasClass("carousel") && (n = s(s({}, f(e).data()), f(this).data()), (i = this.getAttribute("data-slide-to")) && (n.interval = !1), E._jQueryInterface.call(f(e), n), i && f(e).data("bs.carousel").to(i), t.preventDefault())
        }, r(E, null, [{
            key: "VERSION",
            get: function() {
                return "4.5.0"
    ...
    }), f.fn[y] = C._jQueryInterface, f.fn[y].Constructor = C, f.fn[y].noConflict = function() {
        return f.fn[y] = _, C._jQueryInterface
    };
    var T, S = "collapse",
        k = f.fn[S],
        I = {
        ...
        O = ((T = D.prototype).toggle = function() {
            ...
            if (!this._isTransitioning && f(this._element).hasClass("show")) {
                ...
                if (f(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", m.reflow(this._element), f(this._element).addClass("collapsing").removeClass("collapse show");
                    var i = this._triggerArray.length;
                    if (0 < i)
                        for (var o = 0; o < i; o++) {
                            var r = this._triggerArray[o],
                                s = m.getSelectorFromElement(r);
                            null !== s && (f([].slice.call(document.querySelectorAll(s))).hasClass("show") || f(r).addClass("collapsed").attr("aria-expanded", !1))
                        }
            ...
            return (t = s(s({}, I), t)).toggle = Boolean(t.toggle), m.typeCheckConfig(S, t, A), t
            ...
            return f(i).each(function(t, e) {
                n._addAriaAndCollapsedClass(D._getTargetFromElement(e), [e])
            }), t
        }, T._addAriaAndCollapsedClass = function(t, e) {
            var n = f(t).hasClass("show");
            e.length && f(e).toggleClass("collapsed", !n).attr("aria-expanded", n)
        }, D._getTargetFromElement = function(t) {
            var e = m.getSelectorFromElement(t);
            ...
            return this.each(function() {
                ...
                if (!e && n.toggle && "string" == typeof i && /show|hide/.test(i) && (n.toggle = !1), e || (e = new D(this, n), t.data("bs.collapse", e)), "string" == typeof i) {
    ...
    }), f.fn[S] = O._jQueryInterface, f.fn[S].Constructor = O, f.fn[S].noConflict = function() {
        return f.fn[S] = k, O._jQueryInterface
    };
    var L, N = "dropdown",
        j = f.fn[N],
        ...
        M = ((L = q.prototype).toggle = function() {
            var t;
            this._element.disabled || f(this._element).hasClass("disabled") || (t = f(this._menu).hasClass("show"), q._clearMenus(), t || this.show(!0))
        }, L.show = function(t) {
            if (void 0 === t && (t = !1), !(this._element.disabled || f(this._element).hasClass("disabled") || f(this._menu).hasClass("show"))) {
                ...
                if (f(i).trigger(n), !n.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        ...
                        var o = this._element;
                        "parent" === this._config.reference ? o = i : m.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && f(i).addClass("position-static"), this._popper = new h(o, this._menu, this._getPopperConfig())
                    }
            ...
            this._element.disabled || f(this._element).hasClass("disabled") || !f(this._menu).hasClass("show") || (t = {
                relatedTarget: this._element
            }, e = f.Event("hide.bs.dropdown", t), n = q._getParentFromElement(this._element), f(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), f(this._menu).toggleClass("show"), f(n).toggleClass("show").trigger(f.Event("hidden.bs.dropdown", t))))
        }, L.dispose = function() {
            ...
            return t = s(s(s({}, this.constructor.Default), f(this._element).data()), t), m.typeCheckConfig(N, t, this.constructor.DefaultType), t
            ...
            return this.each(function() {
                ...
                if (t || (t = new q(this, "object" == typeof e ? e : null), f(this).data("bs.dropdown", t)), "string" == typeof e) {
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var e = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), n = 0, i = e.length; n < i; n++) {
                    var o, r, s = q._getParentFromElement(e[n]),
                        a = f(e[n]).data("bs.dropdown"),
                        l = {
                            relatedTarget: e[n]
                        };
                    t && "click" === t.type && (l.clickEvent = t), a && (o = a._menu, !f(s).hasClass("show") || t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && f.contains(s, t.target) || (r = f.Event("hide.bs.dropdown", l), f(s).trigger(r), r.isDefaultPrevented() || ("ontouchstart" in document.documentElement && f(document.body).children().off("mouseover", null, f.noop), e[n].setAttribute("aria-expanded", "false"), a._popper && a._popper.destroy(), f(o).removeClass("show"), f(s).removeClass("show").trigger(f.Event("hidden.bs.dropdown", l)))))
                }
        }, q._getParentFromElement = function(t) {
            var e, n = m.getSelectorFromElement(t);
            return n && (e = document.querySelector(n)), e || t.parentNode
        }, q._dataApiKeydownHandler = function(t) {
            if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || f(t.target).closest(".dropdown-menu").length) : !z.test(t.which)) && !this.disabled && !f(this).hasClass("disabled")) {
    ...
    var R, W = f.fn.modal,
        ...
        B = ((R = Q.prototype).toggle = function(t) {
            ...
            var e, n, i, o = this;
            t && t.preventDefault(), this._isShown && !this._isTransitioning && (e = f.Event("hide.bs.modal"), f(this._element).trigger(e), this._isShown && !e.isDefaultPrevented() && (this._isShown = !1, (n = f(this._element).hasClass("fade")) && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), f(document).off("focusin.bs.modal"), f(this._element).removeClass("show"), f(this._element).off("click.dismiss.bs.modal"), f(this._dialog).off("mousedown.dismiss.bs.modal"), n ? (i = m.getTransitionDurationFromElement(this._element), f(this._element).one(m.TRANSITION_END, function(t) {
            ...
            return t = s(s({}, F), t), m.typeCheckConfig("modal", t, $), t
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), f(this._dialog).hasClass("modal-dialog-scrollable") && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && m.reflow(this._element), f(this._element).addClass("show"), this._config.focus && this._enforceFocus();
            var r, s = f.Event("shown.bs.modal", {
                relatedTarget: t
            });
            n ? (r = m.getTransitionDurationFromElement(this._dialog), f(this._dialog).one(m.TRANSITION_END, o).emulateTransitionEnd(r)) : o()
            ...
            var e, n, i = this,
                o = f(this._element).hasClass("fade") ? "fade" : "";
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", o && this._backdrop.classList.add(o), f(this._backdrop).appendTo(document.body), f(this._element).on("click.dismiss.bs.modal", function(t) {
                        i._ignoreBackdropClick ? i._ignoreBackdropClick = !1 : t.target === t.currentTarget && i._triggerBackdropTransition()
                    }), o && m.reflow(this._backdrop), f(this._backdrop).addClass("show"), !t) return;
                if (!o) return void t();
                var r = m.getTransitionDurationFromElement(this._backdrop);
                f(this._backdrop).one(m.TRANSITION_END, t).emulateTransitionEnd(r)
            } else !this._isShown && this._backdrop ? (f(this._backdrop).removeClass("show"), e = function() {
                i._removeBackdrop(), t && t()
            }, f(this._element).hasClass("fade") ? (n = m.getTransitionDurationFromElement(this._backdrop), f(this._backdrop).one(m.TRANSITION_END, e).emulateTransitionEnd(n)) : e()) : t && t()
            ...
            return this.each(function() {
                var t = f(this).data("bs.modal"),
                    e = s(s(s({}, F), f(this).data()), "object" == typeof n && n ? n : {});
                if (t || (t = new Q(this, e), f(this).data("bs.modal", t)), "string" == typeof n) {
                    if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                    t[n](i)
    ...
    f(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
        ...
        var o = f(e).data("bs.modal") ? "toggle" : s(s({}, f(e).data()), f(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var r = f(e).one("show.bs.modal", function(t) {
            t.isDefaultPrevented() || r.one("hidden.bs.modal", function() {
                f(n).is(":visible") && n.focus()
            })
        });
        B._jQueryInterface.call(f(e), o, this)
    }), f.fn.modal = B._jQueryInterface, f.fn.modal.Constructor = B, f.fn.modal.noConflict = function() {
        return f.fn.modal = W, B._jQueryInterface
    };
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(r), a = [].slice.call(n.body.querySelectorAll("*")), i = 0, o = a.length; i < o; i++) ! function(t) {
            ...
            i.forEach(function(t) {
                ! function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n)) return -1 === U.indexOf(n) || Boolean(t.nodeValue.match(V) || t.nodeValue.match(Y));
    ...
    var K, G = "tooltip",
        ...
        rt = ((K = st.prototype).enable = function() {
            this._isEnabled = !0
        }, K.disable = function() {
            this._isEnabled = !1
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && f(o).addClass("fade");
                var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                    a = this._getAttachment(s);
                this.addAttachmentClass(a);
                var l = this._getContainer();
                f(o).data(this.constructor.DATA_KEY, this), f.contains(this.element.ownerDocument.documentElement, this.tip) || f(o).appendTo(l), f(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new h(this.element, o, this._getPopperConfig(a)), f(o).addClass("show"), "ontouchstart" in document.documentElement && f(document.body).children().on("mouseover", null, f.noop);
                var c, u = function() {
                    e.config.animation && e._fixTransition();
                    var t = e._hoverState;
                    e._hoverState = null, f(e.element).trigger(e.constructor.Event.SHOWN), "out" === t && e._leave(null, e)
                };
                f(this.tip).hasClass("fade") ? (c = m.getTransitionDurationFromElement(this.tip), f(this.tip).one(m.TRANSITION_END, u).emulateTransitionEnd(c)) : u()
            }
        }, K.hide = function(t) {
            function e() {
                "show" !== i._hoverState && o.parentNode && o.parentNode.removeChild(o), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), f(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), t && t()
            }
            var n, i = this,
                o = this.getTipElement(),
                r = f.Event(this.constructor.Event.HIDE);
            f(this.element).trigger(r), r.isDefaultPrevented() || (f(o).removeClass("show"), "ontouchstart" in document.documentElement && f(document.body).children().off("mouseover", null, f.noop), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1, f(this.tip).hasClass("fade") ? (n = m.getTransitionDurationFromElement(o), f(o).one(m.TRANSITION_END, e).emulateTransitionEnd(n)) : e(), this._hoverState = "")
        }, K.update = function() {
        ...
        }, K.setElementContent = function(t, e) {
            "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = X(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? f(e).parent().is(t) || t.empty().append(e) : t.text(f(e).text())
        }, K.getTitle = function() {
            return this.element.getAttribute("data-original-title") || ("function" == typeof this.config.title ? this.config.title.call(this.element) : this.config.title)
        }, K._getPopperConfig = function(t) {
            var e = this;
            return s(s({}, {
                placement: t,
                modifiers: {
            ...
            return Object.keys(e).forEach(function(t) {
                ...
                show: t.delay,
                hide: t.delay
            }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), m.typeCheckConfig(G, t, this.constructor.DefaultType), t.sanitize && (t.template = X(t.template, t.whiteList, t.sanitizeFn)), t
        ...
        }, K._handlePopperPlacementChange = function(t) {
    ...
    f.fn[G] = rt._jQueryInterface, f.fn[G].Constructor = rt, f.fn[G].noConflict = function() {
        return f.fn[G] = Z, rt._jQueryInterface
    };
    var at = "popover",
        lt = f.fn[at],
    ...
    f.fn[at] = pt._jQueryInterface, f.fn[at].Constructor = pt, f.fn[at].noConflict = function() {
        return f.fn[at] = lt, pt._jQueryInterface
    };
    var ft, mt = "scrollspy",
        gt = f.fn[mt],
        vt = {
        ...
        _t = ((ft = bt.prototype).refresh = function() {
            ...
            this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(t) {
                ...
                if (n && (e = document.querySelector(n)), e) {
                    ...
                    if (i.width || i.height) return [f(e)[o]().top + r, n]
                }
                return null
            }).filter(function(t) {
                return t
            ...
            var e;
            return "string" != typeof(t = s(s({}, vt), "object" == typeof t && t ? t : {})).target && m.isElement(t.target) && ((e = f(t.target).attr("id")) || (e = m.getUID(mt), f(t.target).attr("id", e)), t.target = "#" + e), m.typeCheckConfig(mt, t, yt), t
    ...
    }), f.fn[mt] = _t._jQueryInterface, f.fn[mt].Constructor = _t, f.fn[mt].noConflict = function() {
        return f.fn[mt] = gt, _t._jQueryInterface
    };
    var wt, xt = f.fn.tab,
        Ct = ((wt = Et.prototype).show = function() {
            var t, e, n, i, o, r, s, a, l = this;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass("active") || f(this._element).hasClass("disabled") || (e = f(this._element).closest(".nav, .list-group")[0], n = m.getSelectorFromElement(this._element), e && (i = "UL" === e.nodeName || "OL" === e.nodeName ? "> li > .active" : ".active", o = (o = f.makeArray(f(e).find(i)))[o.length - 1]), r = f.Event("hide.bs.tab", {
                relatedTarget: this._element
            }), s = f.Event("show.bs.tab", {
                relatedTarget: o
            }), o && f(o).trigger(r), f(this._element).trigger(s), s.isDefaultPrevented() || r.isDefaultPrevented() || (n && (t = document.querySelector(n)), this._activate(this._element, e), a = function() {
                ...
                f(o).trigger(t), f(l._element).trigger(e)
            ...
            s && a ? (o = m.getTransitionDurationFromElement(s), f(s).removeClass("show").one(m.TRANSITION_END, i).emulateTransitionEnd(o)) : i()
        }, wt._transitionComplete = function(t, e, n) {
            var i, o, r;
            e && (f(e).removeClass("active"), (i = f(e.parentNode).find("> .dropdown-menu .active")[0]) && f(i).removeClass("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)), f(t).addClass("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), m.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && f(t.parentNode).hasClass("dropdown-menu") && ((o = f(t).closest(".dropdown")[0]) && (r = [].slice.call(o.querySelectorAll(".dropdown-toggle")), f(r).addClass("active")), t.setAttribute("aria-expanded", !0)), n && n()
        }, Et._jQueryInterface = function(n) {
            return this.each(function() {
                var t = f(this),
                    e = t.data("bs.tab");
                if (e || (e = new Et(this), t.data("bs.tab", e)), "string" == typeof n) {
    ...
    f(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(), Ct._jQueryInterface.call(f(this), "show")
    }), f.fn.tab = Ct._jQueryInterface, f.fn.tab.Constructor = Ct, f.fn.tab.noConflict = function() {
        return f.fn.tab = xt, Ct._jQueryInterface
    };
    var Tt, St = f.fn.toast,
        kt = {
            animation: "boolean",
            autohide: "boolean",
            delay: "number"
        ...
        At = ((Tt = Ot.prototype).show = function() {
            var t, e, n = this,
            ...
            }, this._element.classList.remove("hide"), m.reflow(this._element), this._element.classList.add("showing"), this._config.animation ? (e = m.getTransitionDurationFromElement(this._element), f(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(e)) : t())
        }, Tt.hide = function() {
            var t;
            ...
            return t = s(s(s({}, It), f(this._element).data()), "object" == typeof t && t ? t : {}), m.typeCheckConfig("toast", t, this.constructor.DefaultType), t
            ...
            var e, n = this;
            this._element.classList.remove("show"), this._config.animation ? (e = m.getTransitionDurationFromElement(this._element), f(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(e)) : t()
    ...
    f.fn.toast = At._jQueryInterface, f.fn.toast.Constructor = At, f.fn.toast.noConflict = function() {
        return f.fn.toast = St, At._jQueryInterface
    }, t.Alert = l, t.Button = p, t.Carousel = C, t.Collapse = O, t.Dropdown = M, t.Modal = B, t.Popover = pt, t.Scrollspy = _t, t.Tab = Ct, t.Toast = At, t.Tooltip = rt, t.Util = m, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}),
function(s) {
    ...
    s.scrollIt = function(t) {
        function i(t) {
            var e;
            t < 0 || n < t || (e = s("[data-scroll-index=" + t + "]").offset().top + o.topOffset + 1, s("html,body").animate({
                scrollTop: e,
                easing: o.easing
            }, o.scrollTime))
        }
        var o = s.extend(e, t),
            r = 0,
            n = s("[data-scroll-index]:last").attr("data-scroll-index");
        s(window).on("scroll", function() {
            var t, n = s(window).scrollTop(),
                e = s("[data-scroll-index]").filter(function(t, e) {
                    return n >= s(e).offset().top + o.topOffset && n < s(e).offset().top + o.topOffset + s(e).outerHeight()
                }).first().attr("data-scroll-index");
            t = e, o.onPageChange && t && r != t && o.onPageChange(t), r = t, s("[data-scroll-nav]").removeClass(o.activeClass), s("[data-scroll-nav=" + t + "]").addClass(o.activeClass)
        }).scroll(), s(window).on("keydown", function(t) {
            var e = t.which;
            return (!s("html,body").is(":animated") || e != o.upKey && e != o.downKey) && (e == o.upKey && 0 < r ? (i(parseInt(r) - 1), !1) : !(e == o.downKey && r < n) || (i(parseInt(r) + 1), !1))
        }), s("body").on("click", "[data-scroll-nav], [data-scroll-goto]", function(t) {
            var e, n;
            t.preventDefault(), n = s((e = t).target).closest("[data-scroll-nav]").attr("data-scroll-nav") || s(e.target).closest("[data-scroll-goto]").attr("data-scroll-goto"), i(parseInt(n))
        })
    }
}(jQuery),
function(i) {
    ...
    i.fn.menumaker = function(t) {
        ...
        return this.each(function() {
            i(this).find(".navbar-toggler").on("click", function() {
            ...
            "multitoggle" === n.format ? (e.find(".has-sub").prepend('<span class="submenu-button"></span>'), e.find(".navbar-nav > li.has-sub > .submenu-button").on("click", function() {
                i(this).next(".sub-menu").slideToggle(), i(this).siblings("ul").addClass("open").slideToggle(), i(this).parents(".navbar-nav > li.has-sub").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active")
            }), e.find(".sub-menu > li.has-sub > .submenu-button").on("click", function() {
                i(this).next(".sub-menu").slideToggle(), i(this).siblings("ul").addClass("open").slideToggle(), i(this).parents(".sub-menu > li").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active"), i(this).siblings("ul").hasClass("open") && i(this).parents("li").eq(1).addClass("active")
            })) : e.addClass("dropdown"), !0 === n.sticky && e.css("position", "fixed");
        ...
        i(".navbar-nav li").find('a[href="' + e + '"]').closest("li").addClass("active").parents().eq(1).addClass("current"), i(".navbar-nav li.has-sub ul li").find('a[href="' + e + '"]').parents().eq(4).addClass("current")
        ...
        easyResponsiveTabs: function(l) {
            ...
            f(this).on("bind", "tabactivate", function(t, e) {
                ...
                r.find(".resp-accordion").each(function() {
                    n = f(this);
                    var t = r.find(".resp-tab-item:eq(" + i + ")"),
                        e = r.find(".resp-accordion:eq(" + i + ")");
                ...
                var o, a = 0;
                "" == d || null !== (o = d.match(new RegExp(s + "([0-9]+)"))) && 2 === o.length && (a = parseInt(o[1], 10) - 1, e < a && (a = 0)), f(r.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg,
                    "border-color": l.active_border_color
                }), !0 === l.closed || "accordion" === l.closed && !t.is(":visible") || "tabs" === l.closed && t.is(":visible") || (f(r.find(".resp-accordion." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg + " !important",
                    "border-color": l.active_border_color,
                    background: "none"
                }), f(r.find(".resp-tab-content." + l.tabidentify)[a]).addClass("resp-tab-content-active").addClass(l.tabidentify).attr("style", "display:block")), r.find("[role=tab]").each(function() {
                    f(this).on("click", function() {
                        var t, e, n, i = f(this),
                            o = i.attr("aria-controls");
                        if (i.hasClass("resp-accordion") && i.hasClass("resp-tab-active")) return r.find(".resp-tab-content-active." + l.tabidentify).slideUp("", function() {
                            f(this).addClass("resp-accordion-closed")
                        }), i.removeClass("resp-tab-active").css({}), !1;
                        !i.hasClass("resp-tab-active") && i.hasClass("resp-accordion") ? (r.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}), r.find(".resp-tab-content-active." + l.tabidentify).slideUp().removeClass("resp-tab-content-active resp-accordion-closed"), r.find("[aria-controls=" + o + "]").addClass("resp-tab-active").css({}), r.find(".resp-tab-content[aria-labelledby = " + o + "]." + l.tabidentify).slideDown().addClass("resp-tab-content-active")) : (r.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}), r.find(".resp-tab-content-active." + l.tabidentify).removeAttr("style").removeClass("resp-tab-content-active").removeClass("resp-accordion-closed"), r.find("[aria-controls=" + o + "]").addClass("resp-tab-active").css({}), r.find(".resp-tab-content[aria-labelledby = " + o + "]." + l.tabidentify).addClass("resp-tab-content-active").attr("style", "display:block")), i.trigger("tabactivate", i), p && (t = window.location.hash, o.split("tab_item-"), n = (n = "") != t ? (e = new RegExp(s + "[0-9]+"), null != t.match(e) ? t.replace(e, n) : t + "|" + n) : "" + n, history.replaceState(null, null, n))
                    })
...
function(o, r) {
    ...
    function c(t) {
...
}(window.Zepto || window.jQuery, (window, void document)), jQuery(document).ready(function(s) {
        var a = 2500,
            l = 3800,
            c = l - 3e3,
            o = 50,
        ...
        function p(t) {
            ...
            t.parents(".cd-headline").hasClass("type") ? ((e = t.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function() {
                ...
                f(i, r)
            }, h)) : t.parents(".cd-headline").hasClass("letters") ? (n = t.children("i").length >= i.children("i").length, function t(e, n, i, o) {
                ...
                e.is(":last-child") ? i && setTimeout(function() {
                    ...
                    var r;
                    e.is(":last-child") && s("html").hasClass("no-csstransitions") && (r = g(n), v(n, r))
                }
            }(t.find("i").eq(0), t, n, o), m(i.find("i").eq(0), i, n, o)) : t.parents(".cd-headline").hasClass("clip") ? t.parents(".cd-words-wrapper").animate({
                width: "2px"
            }, d, function() {
                v(t, i), f(i)
            }) : t.parents(".cd-headline").hasClass("loading-bar") ? (t.parents(".cd-words-wrapper").removeClass("is-loading"), v(t, i), setTimeout(function() {
                p(i)
            }, l), setTimeout(function() {
                t.parents(".cd-words-wrapper").addClass("is-loading")
            }, c)) : (v(t, i), setTimeout(function() {
                p(i)
            }, a))
        }
        ...
        function(t) {
            ...
            t.each(function() {
                ...
                }, c)) : o.hasClass("clip") ? (e = (t = o.find(".cd-words-wrapper")).width() + 10, t.css("width", e)) : o.hasClass("type") || (n = o.find(".cd-words-wrapper b"), i = 0, n.each(function() {
                    var t = s(this).width();
                    i < t && (i = t)
                }), o.find(".cd-words-wrapper").css("width", i)), setTimeout(function() {
        ...
        n.fn.counterUp = function(t) {
            ...
            return this.each(function() {
                var l = n(this),
                    c = e;
                l.waypoint(function() {
                    for (var t = [], e = c.time / c.delay, n = l.text(), i = /[0-9]+,[0-9]+/.test(n), n = n.replace(/,/g, ""), o = (/^[0-9]+$/.test(n), /^[0-9]+\.[0-9]+$/.test(n)), r = o ? (n.split(".")[1] || []).length : 0, s = e; 1 <= s; s--) {
                        var a = parseInt(n / e * s);
                        if (o && (a = parseFloat(n / e * s).toFixed(r)), i)
                            for (;
        ...
        c.prototype = {
            ...
            _findParticles: function() {
                ...
                this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                    ...
                    m.options.showElement(u), u.data("stellar-startingLeft") ? (u.css("left", u.data("stellar-startingLeft")), u.css("top", u.data("stellar-startingTop"))) : (u.data("stellar-startingLeft", u.css("left")), u.data("stellar-startingTop", u.css("top"))), i = u.position().left, o = u.position().top, r = "auto" === u.css("margin-left") ? 0 : parseInt(u.css("margin-left"), 10), s = "auto" === u.css("margin-top") ? 0 : parseInt(u.css("margin-top"), 10), l = u.offset().left - r, c = u.offset().top - s, u.parents().each(function() {
                        var t = g(this);
                        if (!0 === t.data("stellar-offset-parent")) return h = p, d = f, a = t, !1;
            ...
            _findBackgrounds: function() {
                ...
                this.backgrounds = [], this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)), t.each(function() {
                    ...
                    a.data("stellar-backgroundStartingLeft") ? y(a, a.data("stellar-backgroundStartingLeft"), a.data("stellar-backgroundStartingTop")) : (a.data("stellar-backgroundStartingLeft", l[0]), a.data("stellar-backgroundStartingTop", l[1])), n = "auto" === a.css("margin-left") ? 0 : parseInt(a.css("margin-left"), 10), i = "auto" === a.css("margin-top") ? 0 : parseInt(a.css("margin-top"), 10), o = a.offset().left - n - f, r = a.offset().top - i - m, a.parents().each(function() {
                        var t = g(this);
                        if (!0 === t.data("stellar-offset-parent")) return c = h, u = d, s = t, !1;
                        h += t.position().left, d += t.position().top
                    }), t = a.data("stellar-horizontal-offset") !== v ? a.data("stellar-horizontal-offset") : s !== v && s.data("stellar-horizontal-offset") !== v ? s.data("stellar-horizontal-offset") : p.horizontalOffset, e = a.data("stellar-vertical-offset") !== v ? a.data("stellar-vertical-offset") : s !== v && s.data("stellar-vertical-offset") !== v ? s.data("stellar-vertical-offset") : p.verticalOffset, p.backgrounds.push({
                        $element: a,
                        $offsetParent: s,
    ...
    function() {
        ...
        function n(t) {
            this.element = t, this.Adapter = g.Adapter, this.adapter = new this.Adapter(t), this.key = "waypoint-context-" + i, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
                ...
                vertical: {},
                horizontal: {}
            }, t.waypointContextKey = this.key, o[t.waypointContextKey] = this, i += 1, g.windowContext || (g.windowContext = !0, g.windowContext = new n(window)), this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
        }
        var i = 0,
            o = {},
            g = window.Waypoint,
        ...
        n.prototype.add = function(t) {
            ...
            for (var n in e) {
                ...
                for (var r in this.waypoints[n]) {
                    var s, a, l = this.waypoints[n][r];
                    null !== l.triggerPoint && (s = i.oldScroll < l.triggerPoint, a = i.newScroll >= l.triggerPoint, (s && a || !s && !a) && (l.queueTrigger(o), t[l.group.id] = l.group))
                }
            }
            ...
            for (var o in this.handleScroll(), t = {
                ...
                for (var s in this.waypoints[o]) {
                    var a, l, c, u, h = this.waypoints[o][s],
                        d = h.options.offset,
                        p = h.triggerPoint,
                        f = 0,
                        m = null == p;
                    h.element !== h.element.window && (f = h.adapter.offset()[r.offsetProp]), "function" == typeof d ? d = d.apply(h) : "string" == typeof d && (d = parseFloat(d), -1 < h.options.offset.indexOf("%") && (d = Math.ceil(r.contextDimension * d / 100))), a = r.contextScroll - r.contextOffset, h.triggerPoint = Math.floor(f + a - d), l = p < r.oldScroll, c = h.triggerPoint >= r.oldScroll, u = !l && !c, !m && (l && c) ? (h.queueTrigger(r.backward), i[h.group.id] = h.group) : (!m && u || m && r.oldScroll >= h.triggerPoint) && (h.queueTrigger(r.forward), i[h.group.id] = h.group)
                }
            }
    ...
    function(u) {
        ...
        u.fn.countdown = function(t, s) {
            ...
            function e() {
                ...
                t <= e && (s.call(this), clearInterval(c));
                var n = t - e,
                ...
                n -= 60 * r, 1 == i ? a.find(".timeRefDays").text("day") : a.find(".timeRefDays").text("days"), 1 == o ? a.find(".timeRefHours").text("hour") : a.find(".timeRefHours").text("hours"), 1 == r ? a.find(".timeRefMinutes").text("minute") : a.find(".timeRefMinutes").text("minutes"), 1 == n ? a.find(".timeRefSeconds").text("second") : a.find(".timeRefSeconds").text("seconds"), "on" == l.format && (i = 2 <= String(i).length ? i : "0" + i, o = 2 <= String(o).length ? o : "0" + o, r = 2 <= String(r).length ? r : "0" + r, n = 2 <= String(n).length ? n : "0" + n), isNaN(t) ? (alert("Invalid date. Here's an example: 12 Tuesday 2012 17:30:00"), clearInterval(c)) : (a.find(".days").text(i), a.find(".hours").text(o), a.find(".minutes").text(r), a.find(".seconds").text(n))
            }
            t && u.extend(l, t), e();
    ...
    function(t) {
        ...
        t.prototype = {
            ...
            open: function(t) {
                ...
                if (!m.isOpen) {
                    ...
                    p("BeforeOpen"), m.st.showCloseBtn && (m.st.closeBtnInside ? (h(y, function(t, e, n, i) {
            ...
            _close: function() {
                ...
                m.bgOverlay.detach(), m.wrap.detach(), m.container.empty(), m.st.mainClass && (e += m.st.mainClass + " "), m._removeClassFromMFP(e), m.fixedContentPos && (t = {
                    marginRight: ""
                }, m.isIE7 ? u("body, html").css("overflow", "") : t.overflow = "", u("html").css(t)), g.off("keyup.mfp focusin.mfp"), m.ev.off(n), m.wrap.attr("class", "mfp-wrap").removeAttr("style"), m.bgOverlay.attr("class", "mfp-bg"), m.container.attr("class", "mfp-container"), !m.st.showCloseBtn || m.st.closeBtnInside && !0 !== m.currTemplate[m.currItem.type] || m.currTemplate.closeBtn && m.currTemplate.closeBtn.detach(), m.st.autoFocusLast && m._lastFocusedEl && u(m._lastFocusedEl).focus(), m.currItem = null, m.content = null, m.currTemplate = null, m.prevHeight = 0, p("AfterClose")
            },
            updateSize: function(t) {
                var e, n;
                m.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, n = window.innerHeight * e, m.wrap.css("height", n), m.wH = n) : m.wH = t || w.height(), m.fixedContentPos || m.wrap.css("height", m.wH), p("Resize")
            },
            ...
            _parseMarkup: function(o, t, e) {
                ...
                e.data && (t = u.extend(e.data, t)), p(y, [o, t, e]), u.each(t, function(t, e) {
                    return void 0 === e || !1 === e || void(1 < (r = t.split("_")).length ? 0 < (n = o.find(".mfp-" + r[0])).length && ("replaceWith" === (i = r[1]) ? n[0] !== e[0] && n.replaceWith(e) : "img" === i ? n.is("img") ? n.attr("src", e) : n.replaceWith(u("<img>").attr("src", e).attr("class", n.attr("class"))) : n.attr(r[1], e)) : o.find(".mfp-" + t).html(e));
                    var n, i
                })
            },
            ...
            r();
            var e, n, i, o = u(this);
            return "string" == typeof t ? "open" === t ? (e = b ? o.data("magnificPopup") : o[0].magnificPopup, n = parseInt(arguments[1], 10) || 0, i = e.items ? e.items[n] : (i = o, e.delegate && (i = i.find(e.delegate)), i.eq(n)), m._openClick({
                mfpEl: i
            }, o, e)) : m.isOpen && m[t].apply(m, Array.prototype.slice.call(arguments, 1)) : (t = u.extend(!0, {}, t), b ? o.data("magnificPopup", t) : o[0].magnificPopup = t, m.addGroup(o, t)), o
        };
            ...
            proto: {
                ...
                getInline: function(t, e) {
                    if (x(), t.src) {
                        var n, i = m.st.inline,
                            o = u(t.src);
                        return o.length ? ((n = o[0].parentNode) && n.tagName && (E || (C = i.hiddenClass, E = d(C), C = "mfp-" + C), T = o.after(E).detach().removeClass(C)), m.updateStatus("ready")) : (m.updateStatus("error", i.tNotFound), o = u("<div>")), t.inlineElement = o
                    }
        ...
        u.magnificPopup.registerModule(O, {
            ...
            proto: {
                initAjax: function() {
                    m.types.push(O), A = m.st.ajax.cursor, h(a + "." + O, I), h("BeforeChange.ajax", I)
                },
                getAjax: function(o) {
                    ...
                    var t = u.extend({
                        ...
                        success: function(t, e, n) {
                            ...
                            p("ParseAjax", i), m.appendContent(u(i.data), O), o.finished = !0, k(), m._setFocus(), setTimeout(function() {
                                m.wrap.addClass(_)
        ...
        u.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function() {
                    var t = m.st.image,
                        e = ".image";
                    m.types.push("image"), h("Open" + e, function() {
                    ...
                    }), h("Resize" + e, m.resizeImage), m.isLowIE && h("AfterChange", m.resizeImage)
                },
                    ...
                    var n = 0,
                        ...
                        o = function(t) {
                            D && clearInterval(D), D = setInterval(function() {
                                return 0 < i.naturalWidth ? void m._onImageHasSize(e) : (200 < n && clearInterval(D), void(3 === ++n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)))
                            }, t)
                        };
                    o(1)
                },
        ...
        u.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function(t) {
                    ...
                    var r = {
                        width: e.width(),
                        height: (b ? e.innerHeight() : e[0].offsetHeight) - o - i
                    };
        ...
        u.magnificPopup.registerModule(j, {
            ...
            proto: {
                initIframe: function() {
                    m.types.push(j), h("BeforeChange", function(t, e, n) {
                        e !== n && (e === j ? N() : n === j && N(!0))
                    }), h(a + "." + j, function() {
                        N()
                    })
        ...
        u.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    var r = m.st.gallery,
                        t = ".mfp-gallery";
                    return m.direction = !0, !(!r || !r.enabled) && (v += " mfp-gallery", h("Open" + t, function() {
                        ...
                        e.text && (e.text = P(e.text, m.currItem.index, m.items.length))
                    }), h(y + t, function(t, e, n, i) {
                        var o = m.items.length;
                        n.counter = 1 < o ? P(r.tCounter, i.index, o) : ""
                    }), h("BuildControls" + t, function() {
                        var t, e, n;
                        1 < m.items.length && r.arrows && !m.arrowLeft && (t = r.arrowMarkup, e = m.arrowLeft = u(t.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, "left")).addClass(c), n = m.arrowRight = u(t.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, "right")).addClass(c), e.click(function() {
                            m.prev()
                        }), n.click(function() {
                            m.next()
                ...
                _preloadItem: function(t) {
                    var e;
                    t = z(t), m.items[t].preloaded || ((e = m.items[t]).parsed || (e = m.parseEl(t)), p("LazyLoad", e), "image" === e.type && (e.img = u('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
        ...
        u.magnificPopup.registerModule(H, {
            ...
            proto: {
                initRetina: function() {
                    var n, i;
                    1 < window.devicePixelRatio && (n = m.st.retina, i = n.ratio, 1 < (i = isNaN(i) ? i() : i) && (h("ImageHasSize." + H, function(t, e) {
                        e.img.css({
                            "max-width": e.img[0].naturalWidth / i,
                            width: "100%"
                        })
                    }), h("ElementParse." + H, function(t, e) {
    ...
    function(e, n) {
        ...
        function n(c, o, u) {
            (u = u || e || t.jQuery) && (o.prototype.option || (o.prototype.option = function(t) {
                ...
                var e, r, s, a, l, i, n = h.call(arguments, 1);
                return s = n, l = "$()." + c + '("' + (r = t) + '")', (e = this).each(function(t, e) {
                    var n, i, o = u.data(e, c);
                    o ? (n = o[r]) && "_" != r.charAt(0) ? (i = n.apply(o, s), a = void 0 === a ? i : a) : d(l + " is not a valid method") : d(c + " not initialized. Cannot call methods, i.e. " + l)
                }), void 0 !== a ? a : e
            }, i(u))
        }
    ...
    function(t, e) {
        ...
        function x(t) {
            if (S || (S = !0, (v = document.createElement("div")).style.width = "200px", v.style.padding = "1px 2px 3px 4px", v.style.borderStyle = "solid", v.style.borderWidth = "1px 2px 3px 4px", v.style.boxSizing = "border-box", (y = document.body || document.documentElement).appendChild(v), _ = w(v), x.isBoxSizeOuter = C = 200 == b(_.width), y.removeChild(v)), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                var e = w(t);
                ...
                var g = b(e.height);
                return !1 !== g && (n.height = g + (f ? 0 : c + p)), n.innerWidth = n.width - (l + d), n.innerHeight = n.height - (c + p), n.outerWidth = n.width + u, n.outerHeight = n.height + h, n
            }
            var v, y, _
        }
    ...
    function(o, r) {
        ...
        function s(t, e) {
            ...
            i ? (this.element = i, c && (this.$element = c(this.element)), this.options = r.extend({}, this.constructor.defaults), this.option(e), n = ++u, this.element.outlayerGUID = n, (h[n] = this)._create(), this._getOption("initLayout") && this.layout()) : l && l.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
        }
    ...
    function(t, e) {
        ...
        return ["_resetLayout", "_getItemLayoutPosition", "_manageStamp", "_getContainerSize", "_getElementOffset", "needsResizeLayout", "_getOption"].forEach(function(t) {
            ...
            var n, i = t + e,
                o = "outer" + e;
            this._getMeasurement(i, o), this[i] || (n = this.getFirstItemSize(), this[i] = n && n[o] || this.isotope.size["inner" + e])
    ...
    function(t, e) {
        ...
        return n._resetLayout = function() {
            ...
            t.getSize();
            for (var e = t.size.outerWidth % this.columnWidth, n = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), n = Math.min(n, this.cols), i = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](n, t), o = {
            ...
            var n = this.horizontalColIndex % this.cols,
                ...
                i = e.size.outerWidth && e.size.outerHeight;
    ...
    function(s, a) {
        ...
        l._create = function() {
            ...
            for (var e = (e = this.options.filter) || "*", n = [], i = [], o = [], r = this._getFilterTest(e), s = 0; s < t.length; s++) {
                var a, l = t[s];
        ...
        u.sortDataParsers = {
            ...
            var t, e, s, a;
            this.options.sortBy && (t = r.makeArray(this.options.sortBy), this._getIsSameSortBy(t) || (this.sortHistory = t.concat(this.sortHistory)), s = this.sortHistory, a = this.options.sortAscending, e = function(t, e) {
            ...
            var e, n = this.addItems(t);
            n.length && (e = this._filterRevealAdded(n), this.filteredItems = this.filteredItems.concat(e))
        }, l.prepended = function(t) {
            var e, n = this._itemize(t);
            n.length && (this._resetLayout(), this._manageStamps(), e = this._filterRevealAdded(n), this.layoutItems(this.filteredItems), this.filteredItems = e.concat(this.filteredItems), this.items = n.concat(this.items))
    ...
    function() {
        ...
        u.prototype.extend = function(t, e) {
        ...
        }, u.prototype.createEvent = function(t, e, n, i) {
            var o;
        ...
        }, t = u, n = this.WeakMap || this.MozWeakMap || (c.prototype.get = function(t) {
            for (var e, n, i = e = 0, o = (n = this.keys).length; e < o; i = ++e)
                if (n[i] === t) return this.values[i]
        }, c.prototype.set = function(t, e) {
            for (var n, i, o = n = 0, r = (i = this.keys).length; n < r; o = ++n)
                if (i[o] === t) return void(this.values[o] = e);
            return this.keys.push(t), this.values.push(e)
        }, c), i = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (a.notSupported = !0, a.prototype.observe = function() {}, a), l = this.getComputedStyle || function(n, t) {
            ...
            if (this.stopped = !1, this.boxes = function() {
                    for (var t, e = [], n = 0, i = (t = this.element.querySelectorAll("." + this.config.boxClass)).length; n < i; n++) o = t[n], e.push(o);
                    return e
                }.call(this), this.all = function() {
                    for (var t, e = [], n = 0, i = (t = this.boxes).length; n < i; n++) o = t[n], e.push(o);
                    return e
                }.call(this), this.boxes.length)
                if (this.disabled()) this.resetStyle();
                else
                    for (t = 0, e = (n = this.boxes).length; t < e; t++) o = n[t], this.applyStyle(o, !0);
            return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new i((s = this, function(t) {
                for (var o, r, e = [], n = 0, i = t.length; n < i; n++) r = t[n], e.push(function() {
                    for (var t, e = [], n = 0, i = (t = r.addedNodes || []).length; n < i; n++) o = t[n], e.push(this.doSync(o));
                    return e
                }.call(s));
                return e
            ...
            for (var t, e, n = [], i = 0, o = (e = this.boxes).length; i < o; i++) t = e[i], n.push(t.style.visibility = "visible");
            return n
            ...
            for (r in t) s = t[r], o["" + r] = s, e.push(function() {
                for (var t, e = [], n = 0, i = (t = this.vendors).length; n < i; n++) a = t[n], e.push(o["" + a + r.charAt(0).toUpperCase() + r.substr(1)] = s);
                return e
            }.call(this));
            return e
        }, r.prototype.vendorCSS = function(t, e) {
            for (var n, i, o, r = (i = l(t)).getPropertyCSSValue(e), s = 0, a = (n = this.vendors).length; s < a; s++) o = n[s], r = r || i.getPropertyCSSValue("-" + o + "-" + e);
            return r
            ...
            return !this.scrolled || (this.scrolled = !1, this.boxes = function() {
                for (var t, e = [], n = 0, i = (t = this.boxes).length; n < i; n++)(o = t[n]) && (this.isVisible(o) ? this.show(o) : e.push(o));
                return e
        ...
        }, r.prototype.removeBox = function(t) {
            var e = this.boxes.indexOf(t); - 1 < e && this.boxes.splice(e, 1)
        }, r)
    }.call(this),
    function(o) {
        "use strict";
        o(".switcher-setting").on("click", function() {
            o("#style-switcher").hasClass("active") ? o("#style-switcher").removeClass("active") : (o("#style-switcher").removeClass("active"), o("#style-switcher").addClass("active"))
        }), o(".boxed,.pattren-wrap a").on("click", function() {
            o(".main-wrapper").addClass("wrapper-boxed"), o(".main-wrapper").removeClass("wrapper-wide"), o(window).resize()
        }), o(".wide").on("click", function() {
            o(".main-wrapper").addClass("wrapper-wide"), o(".main-wrapper").removeClass("wrapper-boxed"), o(window).resize()
        }), o(".bg-list li a").on("click", function() {
            var t = o(this).css("backgroundImage");
            o("body").css("backgroundImage", t), o(window).resize()
        }), o(".style1").on("click", function() {
            return o("#colors").attr("href", "css/styles.css"), o("#logo").attr("src", "img/logos/logo_01.png"), o(".white-logo #logo").attr("src", "img/logos/logo-white.png"), o(window).on("scroll", function() {
                var t = o(window).scrollTop(),
                    e = o(".navbar-brand.inner-logo img"),
                    n = o(".navbar-brand.blue-logo img"),
                    i = o(".navbar-brand.dark-logo img");
                t <= 50 ? (e.attr("src", "img/logos/logo-white.png"), n.attr("src", "img/logos/logo-white.png"), i.attr("src", "img/logos/logo_01.png")) : (e.attr("src", "img/logos/logo_01.png"), n.attr("src", "img/logos/logo_01.png"), i.attr("src", "img/logos/logo-white.png"))
            }), !1
        }), o(".style2").on("click", function() {
            return o("#colors").attr("href", "css/styles-2.css"), o("#logo").attr("src", "img/logos/logo_02.png"), o(".white-logo #logo").attr("src", "img/logos/logo-white.png"), o(window).on("scroll", function() {
                var t = o(window).scrollTop(),
                    e = o(".navbar-brand.inner-logo img"),
                    n = o(".navbar-brand.blue-logo img"),
                    i = o(".navbar-brand.dark-logo img");
                t <= 50 ? (e.attr("src", "img/logos/logo-white.png"), n.attr("src", "img/logos/logo-white.png"), i.attr("src", "img/logos/logo_02.png")) : (e.attr("src", "img/logos/logo_02.png"), n.attr("src", "img/logos/logo_02.png"), i.attr("src", "img/logos/logo-white.png"))
            }), !1
        }), o(".style3").on("click", function() {
            return o("#colors").attr("href", "css/styles-3.css"), o("#logo").attr("src", "img/logos/logo_03.png"), o(".white-logo #logo").attr("src", "img/logos/logo-white.png"), o(window).on("scroll", function() {
                var t = o(window).scrollTop(),
                    e = o(".navbar-brand.inner-logo img"),
                    n = o(".navbar-brand.blue-logo img"),
                    i = o(".navbar-brand.dark-logo img");
                t <= 50 ? (e.attr("src", "img/logos/logo-white.png"), n.attr("src", "img/logos/logo-white.png"), i.attr("src", "img/logos/logo_03.png")) : (e.attr("src", "img/logos/logo_03.png"), n.attr("src", "img/logos/logo_03.png"), i.attr("src", "img/logos/logo-white.png"))
            }), !1
        }), o(".style4").on("click", function() {
            return o("#colors").attr("href", "css/styles-4.css"), o("#logo").attr("src", "img/logos/logo_04.png"), o(".white-logo #logo").attr("src", "img/logos/logo-white.png"), o(window).on("scroll", function() {
                var t = o(window).scrollTop(),
                    e = o(".navbar-brand.inner-logo img"),
                    n = o(".navbar-brand.blue-logo img"),
                    i = o(".navbar-brand.dark-logo img");
                t <= 50 ? (e.attr("src", "img/logos/logo-white.png"), n.attr("src", "img/logos/logo-white.png"), i.attr("src", "img/logos/logo_04.png")) : (e.attr("src", "img/logos/logo_04.png"), n.attr("src", "img/logos/logo_04.png"), i.attr("src", "img/logos/logo-white.png"))
            }), !1
        })
    }(jQuery);